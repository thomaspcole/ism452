<div class="card bg-light">
        <div class="card-body">
          <h6>Overview</h6>
          <hr>
          <a class="btn btn-outline-primary btn-sm" href="manage.php">Overview</a>
          <br>
          <br>
          ...
          <hr>
          <a class="btn btn-outline-primary btn-sm" href="#">Open Orders</a>
          <br>
          <br>
          <a class="btn btn-outline-primary btn-sm" href="#">Past Orders</a>
          <br>
          <br>
